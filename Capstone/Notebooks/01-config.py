...
class Config():    
    def __init__(self):      
        self.base_dir_data = "/Volumes/masterdb_dev/demo_db/capstone/data_zone/"
        self.base_dir_checkpoint = "/Volumes/masterdb_dev/demo_db/capstone/checkpoint/"
        self.db_name = "sbit_db" #Schema
