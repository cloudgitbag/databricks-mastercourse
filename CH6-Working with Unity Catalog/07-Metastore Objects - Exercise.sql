...
CREATE CATALOG IF NOT EXISTS masterdb_qa;
...
CREATE SCHEMA IF NOT EXISTS masterdb_dev.demo_db;
...
DROP SCHEMA IF EXISTS masterdb_qa.default;
...
GRANT USE CATALOG on CATALOG masterdb_dev TO `account users`;
...
CREATE VOLUME IF NOT EXISTS  masterdb_dev.demo_db.files;
...
-- MAGIC %fs ls /Volumes/masterdb_dev/demo_db/files/
