...
flight_time_df.write.format("delta").mode("overwrite").saveAsTable("masterdb_dev.demo_db.flight_time_tbl")
...
# MAGIC %sql
# MAGIC Select * From masterdb_dev.demo_db.flight_time_tbl
