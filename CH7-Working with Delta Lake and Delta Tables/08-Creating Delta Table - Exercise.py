...
base_dir = "/Volumes/masterdb_dev/demo_db/files"
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS masterdb_dev.demo_db.flight_time_tbl (
# MAGIC     FL_DATE DATE, 
...
# DBTITLE 1,Create delta table with correct syntax
spark.sql(
    """
        CREATE OR REPLACE TABLE masterdb_dev.demo_db.flight_time_tbl (
            FL_DATE DATE, 
            OP_CARRIER STRING, 
...
flight_time_df.write.mode("overwrite").saveAsTable("masterdb_dev.demo_db.flight_time_tbl")

# COMMAND ----------

df = spark.table("masterdb_dev.demo_db.flight_time_tbl")
df.display()
...
(
    ...
    .tableName("masterdb_dev.demo_db.flight_time_tbl")
