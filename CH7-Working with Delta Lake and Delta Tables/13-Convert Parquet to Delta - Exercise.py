...
df = spark.read.format("parquet").load("/Volumes/masterdb_dev/demo_db/files/fire_calls_tbl")
df.display()
...
# MAGIC %sql 
# MAGIC CONVERT TO DELTA parquet.`/Volumes/masterdb_dev/demo_db/files/fire_calls_tbl`
