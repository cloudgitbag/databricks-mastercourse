...
spark.sql("DROP TABLE IF EXISTS masterdb_dev.demo_db.invoices_raw")
...
ingest()
#Note: It will fail at first, and succeed on retry
...
# MAGIC %fs cp /Volumes/masterdb_dev/demo_db/files/dataset_ch8/invoices_2022.csv /Volumes/masterdb_dev/demo_db/files/dataset_ch8/invoices/
...
# MAGIC %sql
# MAGIC SELECT * FROM masterdb_dev.demo_db.invoices_raw where _rescued_data is not null
