...
# MAGIC DROP SCHEMA IF EXISTS masterdb_dev.default
...
# MAGIC %fs rm /Volumes/masterdb_dev/demo_db/files/dataset_ch8/invoices/invoices_2021.csv
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS masterdb_dev.demo_db.invoices_raw(
# MAGIC   InvoiceNo int,
...
# MAGIC %sql
# MAGIC ALTER TABLE masterdb_dev.demo_db.invoices_raw ADD COLUMNS (Country string)
...
# MAGIC %sql
# MAGIC SELECT * FROM masterdb_dev.demo_db.invoices_raw
# MAGIC -- New Column (Country) is always NULL, since the file was previoulsy processed. 
