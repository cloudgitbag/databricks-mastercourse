...
-- %run ../utils/cleanup
DROP TABLE IF EXISTS masterdb_dev.demo_db.invoices_raw
...
CREATE TABLE IF NOT EXISTS masterdb_dev.demo_db.invoices_raw;

-- COMMAND ----------

-- MAGIC %python
-- MAGIC df = spark.read.format("csv").load("/Volumes/masterdb_dev/demo_db/files/dataset_ch8/invoices/*.csv")
-- MAGIC df.display()
...
DESCRIBE EXTENDED masterdb_dev.demo_db.invoices_raw
